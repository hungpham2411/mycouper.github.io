...
foreach ($categories as $show_categories) {
    ...
    } elseif ($show_categories['cate_Id'] == 13) {
        $category_title13 = $show_categories['cate_Name'];
    } elseif ($show_categories['cate_Id'] == 14) {
        $category_title14 = $show_categories['cate_Name'];
