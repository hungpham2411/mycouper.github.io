...
?>
<center><h2>..:Danh sách tiêu đề:..</h2></center>
...
<td>Hành động</td>
        ...
        if(isset($_GET['pages']) && (int)$_GET['pages']){
            ...
            $query = "SELECT COUNT(cate_Id) FROM categories WHERE cate_UseFor=1";
 ...
 $sql = "SELECT * FROM categories WHERE cate_UseFor=1 ORDER BY cate_Id DESC LIMIT $start, $display";
        ...
        while($set = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            <td style='text-align:center;'><a href='quanly.php?page=edit_category&id=$id'><img src='images/edit.png' width='24px' height='24px'></a></td>
            </tr>";
