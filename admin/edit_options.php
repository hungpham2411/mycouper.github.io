...
<script type="text/javascript">
    function check()
    {
        ...
        seotukhoa7 = document.frm.register_partners_button_name.value;
        if (seotukhoa7 == "")
        {
            document.frm.register_partners_button_name.style.background = '#FFDAB9';
            document.frm.register_partners_button_name.focus();
            return;
        } else {
            document.frm.register_partners_button_name.style.background = '';
        }
...
<div class="container-fluid">
    <h3>Contact</h3>
    <hr>
    <form id="frm" class="form-horizontal" name="frm" action="xulisuaOPTIONS.php" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            <label class="col-sm-2 control-label">Tiêu đề 1</label>
            <div class="col-sm-10">
                <input id="contact-title-1" name="contact_title_1" type="text" value="<?php echo $banner["title_1"]; ?>"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea id="contact-content-1" class="form-control" name="contact_content_1"><?php echo $banner["content_1"]; ?></textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="col-sm-2 control-label">Tiêu đề 2</label>
            <div class="col-sm-10">
                <input id="contact-title-2" name="contact_title_2" type="text" value="<?php echo $banner["title_2"]; ?>"/>
            </div>
        </div>
        ...
        <div class="Group_Right">
            ...
            <div class="dynamiclabel">
                <label>Register partner:</label><br>
                <input id="register_partners_button_name" name="register_partners_button_name" type="text" placeholder="Register partner button name!" value="<?php echo $banner['op_RegisterPartnerButtonName'] ?>">  <a style="color:white;">(*)</a>
            </div>
            <div class="dynamiclabel">
