...
$pdo->query("UPDATE blog SET bl_Title='$title',bl_MetaTitle='$meta_title',bl_Description='$description',bl_MetaDescription='$meta_description',bl_MetaKeywords='$keyword',bl_Url='$url',bl_Content='$content',bl_Picture='$image',bl_Poster='$poster',bl_PostTime='$time',bl_Category='$cate',bl_Tags='$tags',bl_IsShow='$show' WHERE bl_Id='$id'");
