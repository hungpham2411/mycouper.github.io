...
if(isset($_GET['error']) && $_GET['error'] == "out_of_range"){$error = "Kích thước ảnh không quá 5MB";}else{$error = "Thêm tiêu chí mới";}
if(isset($_GET['error']) && $_GET['error'] == "invalid_file_format"){$error = "Định dạng ảnh không hợp lệ";}else{$error = "Thêm tiêu chí mới";}
if(isset($_GET['error']) && $_GET['error'] == "no_image"){$error = "Vui lòng chọn ảnh";}else{$error = "Thêm tiêu chí mới";}
...
<form id="frmNEWS" name="frmNEWS" action="xulithemPRODUCTS.php" method="POST" enctype="multipart/form-data">
<div class="Group_Left">
<div class="dynamiclabel">
<input id="security" name="security" type="hidden" placeholder="Tiêu đề sản phẩm !" value="1">
<input id="id" name="id" type="hidden" placeholder="Tiêu đề sản phẩm !" value="<?php echo $_GET['id'] ?>">
